...
void printPSF( FILE *thePSF, struct atom_rec *at, char **comments = NULL, int ncomments=0);
...
void loadInfo( struct atom_rec *at );
void apply_strain( struct atom_rec *at, int nat, double *LA, double *LB, double *LC, double strain );
void apply_lateral_scale( struct atom_rec *at, int nat, double *LA, double *LB, double *LC, double strain );

void getSegName( int a, char **out );
void getResName( int a, char **out );
void getAtName( int a, char **out );
