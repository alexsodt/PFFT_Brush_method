...
void SolveSpline( int ind)
{
	...
	//dgesv_( &nparams, &nrhs, tA, &nparamstot, ipiv, CUR_SOLUTION, &nparamstot, &info );
	dgesv_( &nparamstot[ind], &nrhs, tA, &nparamstot[ind], ipiv, CUR_SOLUTION[ind], &nparamstot[ind], &info );
